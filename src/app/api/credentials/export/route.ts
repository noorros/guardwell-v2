...
export async function GET() {
  ...
  // holder email, issuing body, and free-text notes (board action history,
  // settlement details). VIEWER/STAFF roles are read-only program
  // participants (consultants, part-time staff) and should not exfiltrate
  // the full credentials register.
